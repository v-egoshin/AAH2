...
exports.registerCandidateCommands = registerCandidateCommands;
const vscode = __importStar(require("vscode"));
const client_1 = require("../api/client");
const assessmentState_1 = require("../state/assessmentState");
function registerCandidateCommands(context) {
    context.subscriptions.push(vscode.commands.registerCommand("appsecWorkbench.acceptCandidate", async () => {
